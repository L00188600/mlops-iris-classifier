...
def preprocess_data(df):
    ...
    # A robust solution would save the scaler with the model.
    
    # As per the model's structure, we are expecting raw input and no
    # explicit scaling in preprocess for prediction.
    ...
    #     print("Scaler not found. Assuming data is already scaled or no scaling needed.")
